    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white font-sans flex">
        ...
        <main class="flex-grow p-8 overflow-y-auto w-full">
            ...
            <div v-if="isAdmin">
                <header class="mb-8">
                    <h1
                        ...
                        {{ t.ui.liquidation.dashboardTitle }}
                    </h1>
                    <p class="text-gray-500 dark:text-gray-400 mt-2">
                        {{ t.ui.liquidation.dashboardSubtitle }}
                    </p>
                </header>
                ...
                <div class="grid lg:grid-cols-2 gap-8 mb-8">
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div>
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <Button :label="t.ui.liquidation.update" @click="handleUpdatePrice"
                                        :loading="isUpdating"
                    ...
                    <div
                        ...
                        <h3 class="text-xl font-bold mb-4 text-gray-900 dark:text-white flex items-center gap-2">
                            ...
                            {{ t.ui.liquidation.interestRateConfig }}
                        </h3>
                        <div class="flex flex-col gap-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        {{ t.ui.liquidation.baseRate }}
                                    </label>
                            ...
                            <div class="pt-2">
                                <Button :label="t.ui.liquidation.updateRates" @click="handleUpdateRates"
                                ...
                                <p class="text-xs text-gray-400 mt-2 text-center">
                                    {{ t.ui.liquidation.rateUpdateNote }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div v-else-if="borrowers.length === 0"
                    ...
                    <p class="text-xl text-gray-500">{{ t.ui.liquidation.noBorrowers }}</p>
                </div>
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr
                                ...
                                <th class="p-4 font-medium">{{ t.ui.liquidation.walletAddress }}</th>
                                <th class="p-4 font-medium">{{ t.ui.liquidation.totalBorrowedMock }}</th>
                                <th class="p-4 font-medium">{{ t.ui.liquidation.totalCollateralEth }}</th>
                                <th class="p-4 font-medium">{{ t.ui.common.healthFactor }}</th>
                                <th class="p-4 font-medium text-right">{{ t.ui.common.action }}</th>
                            </tr>
                        </thead>
                                ...
                                <td class="p-4 text-right">
                                    <button v-if="parseFloat(user.healthFactor) < 1.0"
                                        ...
                                        <span v-if="processingMap[user.address]" class="flex items-center gap-2">
                                            ...
                                            {{ t.ui.liquidation.processing }}
                                        </span>
                                        <span v-else>{{ t.ui.liquidation.liquidateNow }}</span>
                                    </button>
                                    <span v-else class="text-xs text-gray-400 italic">{{ t.ui.liquidation.safe }}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
            ...
            <div v-else class="h-full flex flex-col items-center justify-center text-center p-8">
                ...
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">{{ t.ui.liquidation.accessDenied }}
                </h2>
                <p class="text-gray-500 dark:text-gray-400 max-w-md">
                    {{ t.ui.liquidation.accessDeniedMessage }}
                </p>
            </div>
        </main>
    </div>
