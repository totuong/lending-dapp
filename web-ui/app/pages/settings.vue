...
onMounted(() => {
    ...
    if (localStorage.getItem('darkMode')) darkMode.value = localStorage.getItem('darkMode') === 'true';
    ...
    <main class="flex-grow p-8 overflow-y-auto">
      ...
      <div class="space-y-6 max-w-4xl">
          ...
          <div class="bg-gray-800 rounded-2xl border border-gray-700 p-6">
              ...
              <div class="space-y-4">
                  <div>
                      <label class="block text-gray-500 text-sm mb-1">Lending Pool Address</label>
                  ...
                  <div>
                      <label class="block text-gray-500 text-sm mb-1">Token Address (Mock)</label>
                      <div class="flex items-center gap-2 bg-gray-900 p-3 rounded-lg border border-gray-700">
          ...
          <div class="bg-gray-800 rounded-2xl border border-gray-700 p-6">
              ...
              <div class="space-y-6">
                  <div>
                      <label class="block text-gray-400 mb-2">Slippage Tolerance</label>
                      <div class="flex gap-2">
                          <button 
                            ...
                            :class="slippage === val ? 'bg-purple-600 text-white border-purple-500' : 'bg-gray-900 text-gray-400 border-gray-700 hover:border-gray-500'"
                          >
                              {{ val }}%
                          </button>
                      </div>
                  ...
                  <div class="flex items-center justify-between">
                      <div>
                          <label class="block text-gray-400 font-bold">Infinite Approval</label>
                      ...
                      <button 
                        ...
                        :class="infiniteApproval ? 'bg-green-500' : 'bg-gray-600'"
                      >
                          <div 
              ...
              <div class="space-y-4">
                  <div class="flex items-center justify-between">
                      ...
                      <button 
                        ...
                        class="p-2 bg-gray-900 rounded-lg border border-gray-700 hover:border-gray-500 transition-colors"
                      >
                          <Icon :icon="darkMode ? 'mdi:weather-night' : 'mdi:weather-sunny'" class="w-5 h-5" :class="darkMode ? 'text-blue-300' : 'text-yellow-400'" />
                      </button>
                  </div>
                  <div class="flex items-center justify-between">
                      <span class="text-gray-400">Language</span>
                      <select v-model="language" class="bg-gray-900 border border-gray-700 text-white rounded-lg px-3 py-2 outline-none focus:border-blue-500">
