        ...
        <DataTable v-model:filters="filters" :value="assets" selectionMode="single"
            ...
            <template #header>
                <div class="flex justify-between items-center">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white">{{ t.ui.common.asset }}</h3>
                    <span class="relative">
            ...
            <Column field="name" :header="t.ui.common.asset" sortable>
            ...
            <Column :header="t.ui.common.action">
                <template #body="slotProps">
                    <Button :label="t.ui.common.details" icon="pi pi-info-circle" size="small"
    ...
    <Dialog v-model:visible="visible" modal :header="selectedAsset?.name + ' Details'" :style="{ width: '30rem' }">
        <div v-if="selectedAsset" class="space-y-4">
            ...
            <div class="border-t border-gray-200 dark:border-gray-700 pt-4 mt-4">
                <h4 class="font-bold mb-2">{{ t.ui.common.protocolStats }}</h4>
