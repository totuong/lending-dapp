            ...
            ui: {
                ...
                dashboard: {
                    ...
                    myAssets: {
                        ...
                        connectWalletMessage: "Please connect your wallet to view your assets.",
                        totalSuppliedValue: "Total Supplied Value",
                        totalBorrowedValue: "Total Borrowed Value",
                        healthFactorWarning: "Ensure your health factor stays above 1.0 to avoid liquidation.",
                        noAssetsFound: "No Assets Found",
                        noAssetsMessage: "You haven't supplied or borrowed any assets yet.",
                    ...
                    liquidation: {
                        dashboardTitle: "Liquidation Dashboard",
                        dashboardSubtitle: "Monitor and liquidate unhealthy positions. Hunt for liquidation bonuses!",
                        priceOracle: "Price Oracle",
                        currentEthPrice: "Current ETH Price",
                        newPrice: "New Price (MCK)",
                        update: "Update",
                        interestRateConfig: "Interest Rate Config",
                        baseRate: "Base Rate % (APY)",
                        multiplier: "Multiplier % (Slope)",
                        updateRates: "Update Rates",
                        rateUpdateNote: "Note: Updates apply immediately to global index accrual.",
                        noBorrowers: "No active borrowers found.",
                        walletAddress: "Wallet Address",
                        totalBorrowedMock: "Total Borrowed (Mock)",
                        totalCollateralEth: "Total Collateral (ETH)",
                        liquidateNow: "Liquidate Now",
                        processing: "Processing",
                        safe: "Safe",
                        accessDenied: "Access Denied",
                        accessDeniedMessage: "Only administrators can access the Liquidation Dashboard. Please connect with an authorized wallet to proceed."
                    }
                }
        },
        vi: {
            ...
            ui: {
                ...
                dashboard: {
                    ...
                    myAssets: {
                        ...
                        connectWalletMessage: "Vui lòng kết nối ví để xem tài sản.",
                        totalSuppliedValue: "Tổng giá trị cung cấp",
                        totalBorrowedValue: "Tổng giá trị vay",
                        healthFactorWarning: "Đảm bảo Health Factor > 1.0 để tránh bị thanh lý.",
                        noAssetsFound: "Không tìm thấy tài sản",
                        noAssetsMessage: "Bạn chưa cung cấp hoặc vay tài sản nào.",
                        goToMarket: "Đến thị trường",
                        yourSupplies: "Tài sản cung cấp",
                        yourBorrows: "Khoản vay hiện tại",
                        collateral: "Thế chấp",
                        enabled: "Bật",
                        disabled: "Tắt",
                        debt: "Nợ",
                        withdrawAsset: "Rút tài sản",
                        repayDebt: "Trả nợ",
                        available: "Khả dụng",
                        amount: "Số lượng",
                        cancel: "Hủy",
                    ...
                    liquidation: {
                        dashboardTitle: "Bảng điều khiển thanh lý",
                        dashboardSubtitle: "Theo dõi và thanh lý các vị thế rủi ro. Nhận thưởng thanh lý!",
                        priceOracle: "Oracle Giá",
                        currentEthPrice: "Giá ETH hiện tại",
                        newPrice: "Giá mới (MCK)",
                        update: "Cập nhật",
                        interestRateConfig: "Cấu hình lãi suất",
                        baseRate: "Lãi suất cơ bản % (APY)",
                        multiplier: "Hệ số nhân % (Slope)",
                        updateRates: "Cập nhật lãi suất",
                        rateUpdateNote: "Lưu ý: Cập nhật áp dụng ngay lập tức.",
                        noBorrowers: "Không có người vay nào.",
                        walletAddress: "Địa chỉ ví",
                        totalBorrowedMock: "Tổng vay (Mock)",
                        totalCollateralEth: "Tổng thế chấp (ETH)",
                        liquidateNow: "Thanh lý ngay",
